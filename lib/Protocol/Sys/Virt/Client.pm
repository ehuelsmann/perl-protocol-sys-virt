...
package Protocol::Sys::Virt::Client v10.3.0;
...
use Protocol::Sys::Virt::Client::Domain v10.3.0;
use Protocol::Sys::Virt::Client::DomainCheckpoint v10.3.0;
use Protocol::Sys::Virt::Client::DomainSnapshot v10.3.0;
use Protocol::Sys::Virt::Client::Network v10.3.0;
use Protocol::Sys::Virt::Client::NetworkPort v10.3.0;
use Protocol::Sys::Virt::Client::NwFilter v10.3.0;
use Protocol::Sys::Virt::Client::NwFilterBinding v10.3.0;
use Protocol::Sys::Virt::Client::Interface v10.3.0;
use Protocol::Sys::Virt::Client::StoragePool v10.3.0;
use Protocol::Sys::Virt::Client::StorageVol v10.3.0;
use Protocol::Sys::Virt::Client::NodeDevice v10.3.0;
use Protocol::Sys::Virt::Client::Secret v10.3.0;
...
my @reply_translators = (
    ...
    \&_no_translation,
    \&_no_translation,
    sub { my $client = shift; _translated($client, { ddom => \&_translate_remote_nonnull_domain }, @_) },
    \&_no_translation,
    \&_no_translation,
    \&_no_translation,
    \&_no_translation,
    ...
    \&_no_translation,
    \&_no_translation,
    sub { my $client = shift; _translated($client, { vol => \&_translate_remote_nonnull_storage_vol }, @_) },
    \&_no_translation,
    sub { my $client = shift; _translated($client, { vol => \&_translate_remote_nonnull_storage_vol }, @_) },
    sub { my $client = shift; _translated($client, { vol => \&_translate_remote_nonnull_storage_vol }, @_) },
    sub { my $client = shift; _translated($client, { vol => \&_translate_remote_nonnull_storage_vol }, @_) },
    ...
    \&_no_translation,
    \&_no_translation,
    sub { my $client = shift; _translated($client, { iface => \&_translate_remote_nonnull_interface }, @_) },
    sub { my $client = shift; _translated($client, { iface => \&_translate_remote_nonnull_interface }, @_) },
    \&_no_translation,
    sub { my $client = shift; _translated($client, { iface => \&_translate_remote_nonnull_interface }, @_) },
    \&_no_translation,
    ...
    sub { my $client = shift; _translated($client, { dom => \&_translate_remote_nonnull_domain }, @_) },
    \&_no_translation,
    sub { my $client = shift; _translated($client, { nwfilter => \&_translate_remote_nonnull_nwfilter }, @_) },
    sub { my $client = shift; _translated($client, { nwfilter => \&_translate_remote_nonnull_nwfilter }, @_) },
    \&_no_translation,
    \&_no_translation,
    \&_no_translation,
    ...
    \&_no_translation,
    \&_no_translation,
    sub { my $client = shift; _translated($client, { snap => \&_translate_remote_nonnull_domain_snapshot }, @_) },
    \&_no_translation,
    \&_no_translation,
    \&_no_translation,
    sub { my $client = shift; _translated($client, { snap => \&_translate_remote_nonnull_domain_snapshot }, @_) },
    ...
    \&_no_translation,
    \&_no_translation,
    sub { my $client = shift; _translated($client, { domains => \&_translate_remote_nonnull_domain }, @_) },
    sub { my $client = shift; _translated($client, { snapshots => \&_translate_remote_nonnull_domain_snapshot }, @_) },
    sub { my $client = shift; _translated($client, { snapshots => \&_translate_remote_nonnull_domain_snapshot }, @_) },
    sub { my $client = shift; _translated($client, { dom => \&_translate_remote_nonnull_domain }, @_) },
    \&_no_translation,
    \&_no_translation,
    \&_no_translation,
    \&_no_translation,
    sub { my $client = shift; _translated($client, { pools => \&_translate_remote_nonnull_storage_pool }, @_) },
    sub { my $client = shift; _translated($client, { vols => \&_translate_remote_nonnull_storage_vol }, @_) },
    sub { my $client = shift; _translated($client, { nets => \&_translate_remote_nonnull_network }, @_) },
    sub { my $client = shift; _translated($client, { ifaces => \&_translate_remote_nonnull_interface }, @_) },
    sub { my $client = shift; _translated($client, { devices => \&_translate_remote_nonnull_node_device }, @_) },
    sub { my $client = shift; _translated($client, { filters => \&_translate_remote_nonnull_nwfilter }, @_) },
    sub { my $client = shift; _translated($client, { secrets => \&_translate_remote_nonnull_secret }, @_) },
    \&_no_translation,
    \&_no_translation,
    \&_no_translation,
    \&_no_translation,
    ...
    \&_no_translation,
    \&_no_translation,
    sub { my $client = shift; _translated($client, { nwfilter => \&_translate_remote_nonnull_nwfilter_binding }, @_) },
    \&_no_translation,
    sub { my $client = shift; _translated($client, { nwfilter => \&_translate_remote_nonnull_nwfilter_binding }, @_) },
    \&_no_translation,
    sub { my $client = shift; _translated($client, { bindings => \&_translate_remote_nonnull_nwfilter_binding }, @_) },
    \&_no_translation,
    \&_no_translation,
    sub { my $client = shift; _translated($client, { ports => \&_translate_remote_nonnull_network_port }, @_) },
    sub { my $client = shift; _translated($client, { port => \&_translate_remote_nonnull_network_port }, @_) },
    sub { my $client = shift; _translated($client, { port => \&_translate_remote_nonnull_network_port }, @_) },
    \&_no_translation,
    \&_no_translation,
    \&_no_translation,
    \&_no_translation,
    sub { my $client = shift; _translated($client, { checkpoint => \&_translate_remote_nonnull_domain_checkpoint }, @_) },
    \&_no_translation,
    sub { my $client = shift; _translated($client, { checkpoints => \&_translate_remote_nonnull_domain_checkpoint }, @_) },
    sub { my $client = shift; _translated($client, { checkpoints => \&_translate_remote_nonnull_domain_checkpoint }, @_) },
    sub { my $client = shift; _translated($client, { checkpoint => \&_translate_remote_nonnull_domain_checkpoint }, @_) },
    sub { my $client = shift; _translated($client, { parent => \&_translate_remote_nonnull_domain_checkpoint }, @_) },
    \&_no_translation,
    \&_no_translation,
    \&_no_translation,
    \&_no_translation,
...
The API documentation of this module and the related modules C<Protocol::Sys::Virt::Client::*>
