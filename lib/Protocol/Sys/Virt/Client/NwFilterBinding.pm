...
package Protocol::Sys::Virt::Client::NwFilterBinding v10.3.0;
...
Protocol::Sys::Virt::Client::NwFilterBinding - Client side proxy to remote LibVirt network filter binding
